...
public class Downloader_uns {
	...
	public Downloader_uns(String ip,String str1, String str2,String tr4) throws InterruptedException{
		this.sock = ip;
	    this.Filename = str1;
	...
	public void set_chunk_counter(int max,int curr){
	 ...
	 form.setTitle( (int)rd +" % File Unstable Downloader For : " + sock);
...
//	counprog = x;
	...
	public  void Do_frame(){
		 form = new JFrame();
		 form.setName("File Unstable Manager For : " + sock);
		 form.setTitle("File Unstable Manager For : " + sock);
	        ...
	        form.addWindowListener(new java.awt.event.WindowAdapter() {
			    ...
			    public void windowClosing(java.awt.event.WindowEvent windowEvent) {
			    	 ...
			    	 if (JOptionPane.showConfirmDialog(form, 
					            "Are you sure you want to close File Unstable Downloader From :  "+ sock +" window?", "Close Window?", 
			    		   ...
			    		   String Word = "";
			    			 ...
			    			 String xx = "|||";
			    			 YY = xx.charAt(0)+ "" +xx.charAt(1);
			    		   Master.Send_Data("kill_uns_down" + YY , sock,false);
		...
		//	 form.setBounds((widthx -300),(heightx -200), 300, 150);
		   form.setBounds((widthx -500)/2,( heightx -150)/2, 500, 150);
		        ...
		        message = new JLabel("Status : Unstable Downloading Commanded" );
